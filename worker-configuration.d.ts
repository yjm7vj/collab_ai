/* eslint-disable */
// Generated by Wrangler by running `wrangler types` (hash: 8bc566dd76db11510434faa0971d28f5)
...
interface __BaseEnv_Env {
	...
	UserIndex: DurableObjectNamespace<import("./src/server/index").UserIndex>;
	ProjectIndex: DurableObjectNamespace<import("./src/server/index").ProjectIndex>;
}
declare namespace Cloudflare {
	interface GlobalProps {
		mainModule: typeof import("./src/server/index");
		durableNamespaces: "Room" | "UserIndex" | "ProjectIndex";
	}
...
declare namespace NodeJS {
	interface ProcessEnv extends StringifyValues<Pick<Cloudflare.Env, "ANTHROPIC_API_KEY" | "ROOM_SECRET" | "GITHUB_OAUTH_CLIENT_ID" | "GITHUB_OAUTH_CLIENT_SECRET" | "GITHUB_APP_SLUG" | "GOOGLE_OAUTH_CLIENT_ID" | "GOOGLE_OAUTH_CLIENT_SECRET" | "CLOUDFLARE_ACCOUNT_ID" | "CLOUDFLARE_API_TOKEN">> {}
}
